...
DROP TABLE LETTCRDNMADRZIP CASCADE CONSTRAINTS;
CREATE TABLE LETTCRDNMADRZIP (
	RDNM_CODE VARCHAR2(12) NOT NULL,
	SN NUMBER(10) DEFAULT '0' NOT NULL,
	CTPRVN_NM VARCHAR2(20), 
	SIGNGU_NM VARCHAR2(20), 
	RDNM VARCHAR2(60), 
	...
	LAST_UPDT_PNTTM DATE, 
	LAST_UPDUSR_ID VARCHAR2(20),
	CONSTRAINT LETTCRDNMADRZIP PRIMARY KEY (RDNM_CODE,SN)
);
